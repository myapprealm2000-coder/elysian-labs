...
import { r as reactExports } from "./vendor-80nuMd8G.js";
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, b as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, c as RequestStatusDoneNoReplyErrorCode, d as RejectError, e as CertifiedRejectErrorCode, f as UNREACHABLE_ERROR, I as InputError, g as InvalidReadStateRequestErrorCode, h as ReadRequestType, i as Principal, j as IDL, k as MissingCanisterIdErrorCode, H as HttpAgent, m as encode, Q as QueryResponseStatus, n as UncertifiedRejectErrorCode, o as isV3ResponseBody, p as isV2ResponseBody, q as UncertifiedRejectUpdateErrorCode, r as UnexpectedErrorCode, s as decode, S as Subscribable, t as pendingThenable, v as resolveEnabled, w as shallowEqualObjects, x as resolveStaleTime, y as noop, z as environmentManager, A as isValidTimeout, B as timeUntilStale, D as timeoutManager, F as focusManager, G as fetchState, J as replaceData, K as notifyManager, L as hashKey, N as getDefaultState, O as shouldThrowError, a as useQueryClient, V as useInternetIdentity, W as createActorWithConfig, X as Record, Y as Opt, Z as Vec, _ as Variant, $ as Service, a0 as Func, a1 as Text, a2 as Nat8, a3 as Nat, a4 as Bool, a5 as Null, a6 as Int } from "./index-De5ctwPQ.js";
...
Service({
  ...
  "addLesson": Func(
    [CourseId, LessonId, Text, Text, Text, Nat, Nat],
    [Bool],
    []
  ),
  "attachVideoFile": Func([ProjectId, ExternalBlob], [Bool], []),
  "createCourse": Func([Text, Text, Text], [Course], []),
  "createProject": Func([Text, TemplateType], [Project], []),
  "deleteProject": Func([ProjectId], [Bool], []),
  "getCourse": Func([CourseId], [Opt(Course)], ["query"]),
  "getLessonProgress": Func(
    [Text],
    [Vec(LessonProgress)],
    ["query"]
  ),
  "getProject": Func([ProjectId], [Opt(Project)], ["query"]),
  "listContactMessages": Func([], [Vec(ContactMessage)], ["query"]),
  "listCourses": Func([], [Vec(Course)], ["query"]),
  "listProjects": Func([], [Vec(Project)], ["query"]),
  "markLessonComplete": Func([LessonId, Text], [Bool], []),
  "submitContact": Func([Text, Text, Text], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CourseId2 = IDL2.Text;
  const LessonId2 = IDL2.Text;
  const ProjectId2 = IDL2.Text;
  const ExternalBlob2 = IDL2.Vec(IDL2.Nat8);
  const Lesson2 = IDL2.Record({
    "id": LessonId2,
    "title": IDL2.Text,
    "order": IDL2.Nat,
  ...
  const Course2 = IDL2.Record({
    ...
    "description": IDL2.Text,
    "lessons": IDL2.Vec(Lesson2),
    "instructorName": IDL2.Text
  });
  const TemplateType2 = IDL2.Variant({
    "ad": IDL2.Null,
    "thumbnail": IDL2.Null,
    "blank": IDL2.Null
  });
  ...
  const Project2 = IDL2.Record({
    ...
    "videoFile": IDL2.Opt(ExternalBlob2),
    "templateType": TemplateType2,
    "updatedAt": Timestamp2
  });
  const LessonProgress2 = IDL2.Record({
    "lessonId": LessonId2,
    "completedAt": IDL2.Opt(Timestamp2),
    "userId": IDL2.Text
  });
  const ContactMessageId2 = IDL2.Text;
  const ContactMessage2 = IDL2.Record({
    "id": ContactMessageId2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "isRead": IDL2.Bool,
    "email": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "addLesson": IDL2.Func(
      [CourseId2, LessonId2, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Nat],
      [IDL2.Bool],
      []
    ),
    "attachVideoFile": IDL2.Func([ProjectId2, ExternalBlob2], [IDL2.Bool], []),
    "createCourse": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [Course2], []),
    "createProject": IDL2.Func([IDL2.Text, TemplateType2], [Project2], []),
    "deleteProject": IDL2.Func([ProjectId2], [IDL2.Bool], []),
    "getCourse": IDL2.Func([CourseId2], [IDL2.Opt(Course2)], ["query"]),
    "getLessonProgress": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(LessonProgress2)],
      ["query"]
    ),
    "getProject": IDL2.Func([ProjectId2], [IDL2.Opt(Project2)], ["query"]),
    "listContactMessages": IDL2.Func([], [IDL2.Vec(ContactMessage2)], ["query"]),
    "listCourses": IDL2.Func([], [IDL2.Vec(Course2)], ["query"]),
    "listProjects": IDL2.Func([], [IDL2.Vec(Project2)], ["query"]),
    "markLessonComplete": IDL2.Func([LessonId2, IDL2.Text], [IDL2.Bool], []),
    "submitContact": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [IDL2.Bool], [])
  });
};
...
class Backend {
  ...
  async addLesson(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
  ...
  async attachVideoFile(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async createCourse(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async markLessonComplete(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_LessonProgress_n19(_uploadFile, _downloadFile, value) {
  return from_candid_record_n20(_uploadFile, _downloadFile, value);
}
async function from_candid_Project_n11(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_TemplateType_n15(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n22(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n16(_uploadFile, _downloadFile, value) {
  return "ad" in value ? "ad" : "thumbnail" in value ? "thumbnail" : "blank" in value ? "blank" : value;
}
...
function to_candid_TemplateType_n9(_uploadFile, _downloadFile, value) {
